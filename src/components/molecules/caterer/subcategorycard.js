...
const SubCategoryCard = ({ imageUri, enableSubText, cancelAppointment, passAppointment, title, subText, enableformessage, requestColor, messageTimeText, iconvisible, requestResultText, requestResult, materialIconEnable, mIconName, onPress, circleborder }) => {
                ...
                {iconvisible && (
                    <> 
                     <View style={styles.icon}>
                        <Pressable style={styles.iconOuterCicle}>
                        <MaterialCommunityIcons name='pencil-outline' size={20} color={colors.BtnAcceptBg} onPress={cancelAppointment} />
                        </Pressable>
                        <Pressable style={styles.iconOuterCicle}>
                        <MaterialCommunityIcons style={styles.checkIcon} name='trash-can-outline' size={20} color={colors.BtnRejectBg} onPress={passAppointment} />
                        </Pressable>
                    </View>
...
const styles = StyleSheet.create({
    ...
    cardContainer: {
        ...
        // paddingHorizontal: Metrics.CountScale(1)
    },
    imagecontainer: {
