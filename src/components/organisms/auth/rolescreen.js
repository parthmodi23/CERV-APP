        ...
        <View style={styles.mainscreen}>
                ...
                <View style={styles.rolecontainer}>
                    ...
                    <View style={styles.iconstyle}>
                        <TouchableOpacity style={[styles.imagecontainer, { borderColor: myrole == 'Customer' ? colors.CERVmaincolor : colors.stronglighttext }]}
                            onPress={() => {
                                setmyRole('Customer')
                            }}>
                            <View style={[styles.outerline, { borderColor: myrole == 'Customer' ? colors.CERVmaincolor : colors.stronglighttext }]}>
                    ...
                    <View style={styles.iconstyle}>
                        <TouchableOpacity style={[styles.imagecontainer, { borderColor: myrole == 'Caterer' ? colors.CERVmaincolor : colors.stronglighttext }]} onPress={() => setmyRole('Caterer')}>
                            <View style={[styles.outerline, { borderColor: myrole == 'Caterer' ? colors.CERVmaincolor : colors.stronglighttext }]}>
