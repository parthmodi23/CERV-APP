...
const ChangePasswordScreen = () => {
    ...
    const handleChangePassword = async (values) => {
        ...
        await dispatch(authAction.changeuserpassword(password)).then((res) => {
            setIsLoading(false)
            if (res.success == true) {
                Alert.alert("Congratulatios!", res.message)
            } else {
                ...
                {({ handleChange, handleSubmit, handleBlur, values, touched, errors }) => (
                    <View style={styles.formpart}>
                        <FormInput
                            ...
                            iconname={'lock'}
                            passwordeye={() => setOldPassVisible(!oldPassVisible)}
                        ...
                        <FormInput
                            ...
                            iconname={'lock'}
                            passwordeye={() => setPassVisible(!passVisible)}
                        ...
                        <FormInput
                            ...
                            iconname={'lock'}
                            passwordeye={() => setConfirmPassVisible(!confirmPassvisible)}
